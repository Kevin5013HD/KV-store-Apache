...
class KVMessage:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'value', (TType.STRING,None,TType.STRING,None), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('KVMessage')
    if self.value is not None:
      oprot.writeFieldBegin('value', TType.MAP, 1)
...
class KVException(TException):
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('KVException')
...
class KVServer:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'elements', (TType.STRUCT,(KVMessage, KVMessage.thrift_spec)), None, ), # 1
  )
